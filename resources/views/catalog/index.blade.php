                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ filter_url($category, ['view' => 'list']) }}"
                                   class="@if(is_catalog_view('list')) text-pink pointer-events-none @else text-white @endif inline-flex items-center justify-center w-10 h-10 rounded-md bg-card"
                                >
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 52 52">
